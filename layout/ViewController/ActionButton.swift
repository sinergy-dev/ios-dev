...
//  layout
//
//  Created by Rama Agastya on 16/09/20.
...
open class ActionButton: NSObject {
    ...
    public init(attachedToView view: UIView, items: [ActionButtonItem]?) {
        ...
        self.floatButton.setTitleColor(UIColor.black, for: UIControl.State())
    ...
    */
    fileprivate func installConstraints() {
        ...
        let trailingSpacing = NSLayoutConstraint.constraints(withVisualFormat: "V:[floatButton]-100-|", options: NSLayoutConstraint.FormatOptions.alignAllCenterX, metrics: nil, views: views)
